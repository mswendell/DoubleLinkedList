 ...
 * get you started.
 * 
 * Michael Wendell - CS221-1
 * 
 * @author mvail, mhthomas, awinters, mwendell
 */
...
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(AB_iteratorRemoveAfterNextA_B, "AB_iteratorRemoveAfterNextA_B", LIST_B, STRING_B);
		testSingleElementList(AB_iteratorRemoveAfterNextB_A, "AB_iteratorRemoveAfterNextB_A", LIST_A, STRING_A);
		testTwoElementList(ABC_iteratorRemoveAfterNextA_BC, "ABC_iteratorRemoveAfterNextA_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_iteratorRemoveAfterNextB_AC, "ABC_iteratorRemoveAfterNextB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_iteratorRemoveAfterNextC_AB, "ABC_iteratorRemoveAfterNextC_AB", LIST_AB, STRING_AB);
		
		//ListIterator Scenarios
		testEmptyList(A_listIterRemoveAfterNextA_emptyList, "A_listIterRemoveAfterNextA_emptyList");
		testSingleElementList(AB_listIteratorRemoveAfterNextA_B, "AB_listIteratorRemoveAfterNextA_B", LIST_B, STRING_B);
		testSingleElementList(AB_listIteratorRemoveAfterNextB_A, "AB_listIteratorRemoveAfterNextB_A", LIST_A, STRING_A);
		testTwoElementList(ABC_listIteratorRemoveAfterNextA_BC, "ABC_listIteratorRemoveAfterNextA_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_listIteratorRemoveAfterNextB_AC, "ABC_listIteratorRemoveAfterNextB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_listIteratorRemoveAfterNextC_AB, "ABC_listIteratorRemoveAfterNextC_AB", LIST_AB, STRING_AB);
		testEmptyList(A_listIteratorRemoveAfterPreviousA_emptyList, "A_listIteratorRemoveAfterPreviousA_emptyList");
		testSingleElementList(AB_listIteratorRemoveAfterPreviousA_B, "AB_listIteratorRemoveAfterPreviousA_B", LIST_B, STRING_B);
		testSingleElementList(AB_listIteratorRemoveAfterPreviousB_A, "AB_listIteratorRemoveAfterPreviousB_A", LIST_A, STRING_A);
		testTwoElementList(ABC_listIteratorRemoveAfterPreviousA_BC, "ABC_listIteratorRemoveAfterPreviousA_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_listIteratorRemoveAfterPreviousB_AC, "ABC_listIteratorRemoveAfterPreviousB_AC", LIST_AC, STRING_AC);
		testTwoElementList(ABC_listIteratorRemoveAfterPreviousC_AB, "ABC_listIteratorRemoveAfterPreviousC_AB", LIST_AB, STRING_AB);
		...
		testTwoElementList(A_listIteratorAddBAfterNextA_AB, "A_listIteratorAddBAfterNextA_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_listIteratorAddBAfterPreviousA_BA, "A_listIteratorAddBAfterPreviousA_BA", LIST_BA, STRING_BA);
		testThreeElementList(AB_listIteratorAddC_CAB, "AB_listIteratorAddC_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_listIteratorAddCAfterNextA_ACB, "AB_listIteratorAddCAfterNextA_ACB", LIST_ACB, STRING_ACB);
		testThreeElementList(AB_listIteratorAddCAfterNextB_ABC, "AB_listIteratorAddCAfterNextB_ABC", LIST_ABC, STRING_ABC);
		testThreeElementList(AB_listIteratorAddCAfterPreviousA_CAB, "AB_listIteratorAddCAfterPreviousA_CAB", LIST_CAB, STRING_CAB);
		testThreeElementList(AB_listIteratorAddCAfterPreviousB_ACB, "AB_listIteratorAddCAfterPreviousB_ACB", LIST_ACB, STRING_ACB);
		testSingleElementList(A_listIteratorSetBAfterNextA_B, "A_listIteratorSetBAfterNextA_B", LIST_B, STRING_B);
		testSingleElementList(A_listIteratorSetBAfterPreviousA_B, "A_listIteratorSetBAfterPreviousA_B", LIST_B, STRING_B);
		testTwoElementList(AB_listIteratorSetCAfterNextA_CB, "AB_listIteratorSetCAfterNextA_CB", LIST_CB, STRING_CB);
		...
		testThreeElementList(ABC_listIteratorSetDAfterNextA_DBC, "ABC_listIteratorSetDAfterNextA_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIteratorSetDAfterNextB_ADC, "ABC_listIteratorSetDAfterNextB_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIteratorSetDAfterNextC_ABD, "ABC_listIteratorSetDAfterNextC_ABD", LIST_ABD, STRING_ABD);
		testThreeElementList(ABC_listIteratorSetDAfterPreviousA_DBC, "ABC_listIteratorSetDAfterPreviousA_DBC", LIST_DBC, STRING_DBC);
		testThreeElementList(ABC_listIteratorSetDAfterPreviousB_ADC, "ABC_listIteratorSetDAfterPreviousB_ADC", LIST_ADC, STRING_ADC);
		testThreeElementList(ABC_listIteratorSetDAfterPreviousC_ABD, "ABC_listIteratorSetDAfterPreviousC_ABD", LIST_ABD, STRING_ABD);
...
//			break;
	 ...
	 */
	private IndexedUnsortedList<Integer> AB_iteratorRemoveAfterNextB_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> AB_iteratorRemoveAfterNextB_A = () -> AB_iteratorRemoveAfterNextB_A();
	
	/** Scenario: [A, B, C] -> iteratorRemoveAfterNextA -> [B, C] 
	 * @return [B, C] after iteratorRemoveAfterNextA
	 */
	private IndexedUnsortedList<Integer> ABC_iteratorRemoveAfterNextA_BC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.remove();
	...
	private Scenario<Integer> ABC_iteratorRemoveAfterNextA_BC = () -> ABC_iteratorRemoveAfterNextA_BC();
	
	/** Scenario: [A, B, C] -> iteratorRemoveAfterNextB -> [A, C] 
	 * @return [A, C] after iteratorRemoveAfterNextB
	 */
	private IndexedUnsortedList<Integer> ABC_iteratorRemoveAfterNextB_AC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_iteratorRemoveAfterNextB_AC = () -> ABC_iteratorRemoveAfterNextB_AC();
	
	/** Scenario: [A, B, C] -> iteratorRemoveAfterNextC -> [A, B] 
	 * @return [A, B] after iteratorRemoveAfterNextC
	 */
	private IndexedUnsortedList<Integer> ABC_iteratorRemoveAfterNextC_AB() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> it = list.iterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_iteratorRemoveAfterNextC_AB = () -> ABC_iteratorRemoveAfterNextC_AB();
	...
	/** Scenario: [A, B] -> AB_listIteratorRemoveAfterNextA_B -> [B] 
	...
	private Scenario<Integer> AB_listIteratorRemoveAfterNextA_B = () -> AB_listIteratorRemoveAfterNextA_B();
	...
	private Scenario<Integer> AB_listIteratorRemoveAfterNextB_A = () -> AB_listIteratorRemoveAfterNextB_A();
	
	/** Scenario: [A, B, C] -> listIteratorRemoveAfterNextA -> [B, C] 
	 * @return [B, C] after listIteratorRemoveAfterNextA
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorRemoveAfterNextA_BC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> it = list.listIterator();
		it.next();
		it.remove();
	...
	private Scenario<Integer> ABC_listIteratorRemoveAfterNextA_BC = () -> ABC_listIteratorRemoveAfterNextA_BC();
	
	/** Scenario: [A, B, C] -> listIteratorRemoveAfterNextB -> [A, C] 
	 * @return [A, C] after listIteratorRemoveAfterNextB
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorRemoveAfterNextB_AC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_listIteratorRemoveAfterNextB_AC = () -> ABC_listIteratorRemoveAfterNextB_AC();
	
	/** Scenario: [A, B, C] -> listIteratorRemoveAfterNextC -> [A, B] 
	 * @return [A, B] after listIteratorRemoveAfterNextC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorRemoveAfterNextC_AB() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		Iterator<Integer> it = list.listIterator();
		it.next();
		it.next();
	...
	private Scenario<Integer> ABC_listIteratorRemoveAfterNextC_AB = () -> ABC_listIteratorRemoveAfterNextC_AB();
	
	/** Scenario: [A] -> A_listIteratorRemoveAfterPreviousA_emptyList -> [ ] 
	 * @return [ ] after A_listIteratorRemoveAfterPreviousA_emptyList
	 */
	private IndexedUnsortedList<Integer> A_listIteratorRemoveAfterPreviousA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A(); 
	...
	private Scenario<Integer> A_listIteratorRemoveAfterPreviousA_emptyList = () -> A_listIteratorRemoveAfterPreviousA_emptyList();
	
	/** Scenario: [A, B] -> AB_listIteratorRemoveAfterPreviousA_B -> [B] 
	 * @return [B] after A_listIteratorRemoveAfterPreviousA_B
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorRemoveAfterPreviousA_B() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> AB_listIteratorRemoveAfterPreviousA_B = () -> AB_listIteratorRemoveAfterPreviousA_B();
	
	/** Scenario: [A, B] -> AB_listIteratorRemoveAfterPreviousB_A -> [A] 
	 * @return [A] after A_listIteratorRemoveAfterPreviousB_A
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorRemoveAfterPreviousB_A() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
	...
	private Scenario<Integer> AB_listIteratorRemoveAfterPreviousB_A = () -> AB_listIteratorRemoveAfterPreviousB_A();
	
	/** Scenario: [A, B, C] -> ABC_listIteratorRemoveAfterPreviousA_BC -> [B, C] 
	 * @return [B, C] after ABC_listIteratorRemoveAfterPreviousA_BC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorRemoveAfterPreviousA_BC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> ABC_listIteratorRemoveAfterPreviousA_BC = () -> ABC_listIteratorRemoveAfterPreviousA_BC();
	
	/** Scenario: [A, B, C] -> ABC_listIteratorRemoveAfterPreviousB_AC -> [A, C] 
	 * @return [A, C] after ABC_listIteratorRemoveAfterPreviousB_AC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorRemoveAfterPreviousB_AC() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.remove();
	...
	private Scenario<Integer> ABC_listIteratorRemoveAfterPreviousB_AC = () -> ABC_listIteratorRemoveAfterPreviousB_AC();
	
	/** Scenario: [A, B, C] -> ABC_listIteratorRemoveAfterPreviousC_AB -> [A, B] 
	 * @return [A, B] after ABC_listIteratorRemoveAfterPreviousC_AB
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorRemoveAfterPreviousC_AB() {
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC(); 
	...
	private Scenario<Integer> ABC_listIteratorRemoveAfterPreviousC_AB = () -> ABC_listIteratorRemoveAfterPreviousC_AB();
	...
	private IndexedUnsortedList<Integer> A_listIteratorAddB_BA() {
		IndexedUnsortedList<Integer> list = emptyList_listIteratorAddA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_B);
		return list;
	}
	...
	/** Scenario: [A] -> A_listIteratorAddBAfterNextA_AB -> [A, B] 
	 * @return [A, B] after A_listIteratorAddBAfterNextA_AB
	 */
	private IndexedUnsortedList<Integer> A_listIteratorAddBAfterNextA_AB() {
		IndexedUnsortedList<Integer> list = emptyList_listIteratorAddA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_listIteratorAddBAfterNextA_AB = () -> A_listIteratorAddBAfterNextA_AB();
	
	/** Scenario: [A] -> A_listIteratorAddBAfterPreviousA_BA -> [B, A] 
	 * @return [B, A] after A_listIteratorAddBAfterPreviousA_BA
	 */
	private IndexedUnsortedList<Integer> A_listIteratorAddBAfterPreviousA_BA() {
		IndexedUnsortedList<Integer> list = emptyList_listIteratorAddA_A(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_B);
	...
	private Scenario<Integer> A_listIteratorAddBAfterPreviousA_BA = () -> A_listIteratorAddBAfterPreviousA_BA();
	...
	private IndexedUnsortedList<Integer> AB_listIteratorAddC_CAB() {
		IndexedUnsortedList<Integer> list = A_listIteratorAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.add(ELEMENT_C);
		return list;
	}
	...
	/** Scenario: [A, B] -> AB_listIteratorAddCAfterNextA_ACB -> [A, C, B] 
	 * @return [A, C, B] after AB_listIteratorAddCAfterNextA_ACB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorAddCAfterNextA_ACB() {
		IndexedUnsortedList<Integer> list = A_listIteratorAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIteratorAddCAfterNextA_ACB = () -> AB_listIteratorAddCAfterNextA_ACB();
	
	/** Scenario: [A, B] -> AB_listIteratorAddCAfterNextB_ABC -> [A, B, C] 
	 * @return [A, B, C] after AB_listIteratorAddCAfterNextB_ABC
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorAddCAfterNextB_ABC() {
		IndexedUnsortedList<Integer> list = A_listIteratorAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIteratorAddCAfterNextB_ABC = () -> AB_listIteratorAddCAfterNextB_ABC();
	
	/** Scenario: [A, B] -> AB_listIteratorAddCAfterPreviousA_CAB -> [C, A, B] 
	 * @return [C, A, B] after AB_listIteratorAddC_CAB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorAddCAfterPreviousA_CAB() {
		IndexedUnsortedList<Integer> list = A_listIteratorAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIteratorAddCAfterPreviousA_CAB = () -> AB_listIteratorAddCAfterPreviousA_CAB();
	
	/** Scenario: [A, B] -> AB_listIteratorAddCAfterPreviousB_ACB -> [A, C, B] 
	 * @return [A, C, B] after AB_listIteratorAddCAfterPreviousB_ACB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorAddCAfterPreviousB_ACB() {
		IndexedUnsortedList<Integer> list = A_listIteratorAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.add(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIteratorAddCAfterPreviousB_ACB = () -> AB_listIteratorAddCAfterPreviousB_ACB();
	
	/** Scenario: [A] -> A_listIteratorSetBAfterNextA_B -> [B] 
	 * @return [B] after A_listIteratorSetBAfterNextA_B
	 */
	private IndexedUnsortedList<Integer> A_listIteratorSetBAfterNextA_B() {
		IndexedUnsortedList<Integer> list = emptyList_listIteratorAddA_A(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_listIteratorSetBAfterNextA_B = () -> A_listIteratorSetBAfterNextA_B();
	
	/** Scenario: [A] -> A_listIteratorSetBAfterPreviousA_B -> [B] 
	 * @return [B] after A_listIteratorSetBAfterPreviousA_B
	 */
	private IndexedUnsortedList<Integer> A_listIteratorSetBAfterPreviousA_B() {
		IndexedUnsortedList<Integer> list = emptyList_listIteratorAddA_A(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_B);
	...
	private Scenario<Integer> A_listIteratorSetBAfterPreviousA_B = () -> A_listIteratorSetBAfterPreviousA_B();
	
	/** Scenario: [A, B] -> AB_listIteratorSetCAfterNextA_CB -> [C, B] 
	 * @return [C, B] after AB_listIteratorSetCAfterNextA_CB
	 */
	private IndexedUnsortedList<Integer> AB_listIteratorSetCAfterNextA_CB() {
		IndexedUnsortedList<Integer> list = A_listIteratorAddBAfterNextA_AB(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_C);
	...
	private Scenario<Integer> AB_listIteratorSetCAfterNextA_CB = () -> AB_listIteratorSetCAfterNextA_CB();
	
	/** Scenario: [A, B] -> AB_listIteratorSetCAfterNextB_AC -> [A, C] 
	 * @return [A, C] after AB_listIteratorSetCAfterNextB_AC
	 */
	...
	/** Scenario: [A, B] -> AB_listIteratorSetCAfterPreviousA_CB -> [C, B] 
	 * @return [C, B] after AB_listIteratorSetCAfterPreviousA_CB
	 */
	...
	/** Scenario: [A, B] -> AB_listIteratorSetCAfterPreviousB_AC -> [A, C] 
	 * @return [A, C] after AB_listIteratorSetCAfterPreviousB_AC
	 */
	...
	/** Scenario: [A, B, C] -> ABC_listIteratorSetDAfterNextA_DBC -> [D, B, C] 
	 * @return [D, B, C] after ABC_listIteratorSetDAfterNextA_DBC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorSetDAfterNextA_DBC() {
		IndexedUnsortedList<Integer> list = AB_listIteratorAddCAfterNextB_ABC(); 
		ListIterator<Integer> it = list.listIterator();
		it.next();
		it.set(ELEMENT_D);
		return list;
	}
	private Scenario<Integer> ABC_listIteratorSetDAfterNextA_DBC = () -> ABC_listIteratorSetDAfterNextA_DBC();
	
	/** Scenario: [A, B, C] -> ABC_listIteratorSetDAfterNextB_ADC -> [A, D, C] 
	 * @return [A, D, C] after ABC_listIteratorSetDAfterNextB_ADC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorSetDAfterNextB_ADC() {
		IndexedUnsortedList<Integer> list = AB_listIteratorAddCAfterNextB_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIteratorSetDAfterNextB_ADC = () -> ABC_listIteratorSetDAfterNextB_ADC();
	
	
	/** Scenario: [A, B, C] -> ABC_listIteratorSetDAfterNextC_ABD -> [A, B, D] 
	 * @return [A, B, D] after ABC_listIteratorSetDAfterNextC_ABD
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorSetDAfterNextC_ABD() {
		IndexedUnsortedList<Integer> list = AB_listIteratorAddCAfterNextB_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.next();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIteratorSetDAfterNextC_ABD = () -> ABC_listIteratorSetDAfterNextC_ABD();
	
	/** Scenario: [A, B, C] -> ABC_listIteratorSetDAfterPreviousA_DBC -> [D, B, C] 
	 * @return [D, B, C] after ABC_listIteratorSetDAfterPreviousA_DBC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorSetDAfterPreviousA_DBC() {
		IndexedUnsortedList<Integer> list = AB_listIteratorAddCAfterNextB_ABC(); 
		ListIterator<Integer> it = list.listIterator(1);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIteratorSetDAfterPreviousA_DBC = () -> ABC_listIteratorSetDAfterPreviousA_DBC();
	
	/** Scenario: [A, B, C] -> ABC_listIteratorSetDAfterPreviousB_ADC -> [A, D, C] 
	 * @return [A, D, C] after ABC_listIteratorSetDAfterPreviousB_ADC
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorSetDAfterPreviousB_ADC() {
		IndexedUnsortedList<Integer> list = AB_listIteratorAddCAfterNextB_ABC(); 
		ListIterator<Integer> it = list.listIterator(2);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIteratorSetDAfterPreviousB_ADC = () -> ABC_listIteratorSetDAfterPreviousB_ADC();
	
	
	/** Scenario: [A, B, C] -> ABC_listIteratorSetDAfterPreviousC_ABD -> [A, B, D] 
	 * @return [A, B, D] after ABC_listIteratorSetDAfterPreviousC_ABD
	 */
	private IndexedUnsortedList<Integer> ABC_listIteratorSetDAfterPreviousC_ABD() {
		IndexedUnsortedList<Integer> list = AB_listIteratorAddCAfterNextB_ABC(); 
		ListIterator<Integer> it = list.listIterator(3);
		it.previous();
		it.set(ELEMENT_D);
	...
	private Scenario<Integer> ABC_listIteratorSetDAfterPreviousC_ABD = () -> ABC_listIteratorSetDAfterPreviousC_ABD();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
			    ...
			    printTest(scenarioName + "_testListIterNextNextNext", testIterNext(listIterAfterNext(scenario.build().listIterator(), 2), null, Result.NoSuchElement));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			if (SUPPORTS_LIST_ITERATOR) {
			    ...
			    printTest(scenarioName + "_testListIterNextNextNext", testIterNext(listIterAfterNext(scenario.build().listIterator(), 2), contents[2], Result.MatchingValue));
			    printTest(scenarioName + "_testListIterNextNextNextNext", testIterNext(listIterAfterNext(scenario.build().listIterator(), 3), null, Result.NoSuchElement));
			    printTest(scenarioName + "_testListIterNextNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 2), Result.NoException));
			    printTest(scenarioName + "_testListIterNextNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.IllegalState));
			    printTest(scenarioName + "_testListIter0HasNext", testIterHasNext(scenario.build().listIterator(0), Result.True));
			    printTest(scenarioName + "_testListIter0Next", testIterNext(scenario.build().listIterator(0), contents[0], Result.MatchingValue));
			    ...
			    printTest(scenarioName + "_testListIter2PreviousPreviousNextAdd", testListIterAdd(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 1), ELEMENT_X, Result.NoException));			
			    printTest(scenarioName + "_testListIter2PreviousPreviousNextSet", testListIterSet(listIterAfterNext(listIterAfterPrevious(scenario.build().listIterator(2), 2), 1), ELEMENT_X, Result.NoException));
			    printTest(scenarioName + "_testListIter2NextNext", testIterNext(listIterAfterNext(scenario.build().listIterator(2), 1), null, Result.NoSuchElement));
			    ...
			    printTest(scenarioName + "_testListIter3PreviousPreviousPreviousPrevious", testListIterPrevious(listIterAfterPrevious(scenario.build().listIterator(3), 3), null, Result.NoSuchElement));
			} else {
				printTest(scenarioName + "_testListIter", testListIter(scenario.build(), Result.UnsupportedOperation));
				printTest(scenarioName + "_testListIter0", testListIter(scenario.build(), 0, Result.UnsupportedOperation));
			}
